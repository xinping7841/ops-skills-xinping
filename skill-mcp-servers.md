...
- **注意**：最新版可能与 Node.js 存在 ESM 兼容问题，需固定版本：
  ```bash
  # 配置中使用 @modelcontextprotocol/server-filesystem@0.6.2
  ```
- `trustScope` 设为 `workspace`，`trustedWorkspaceRoots` 指定允许访问的目录
...
*最后更新：2026-06-13 | 由 macair Kun 创建 | k402 补充关键发现及 filesystem*
